...
<p>
	...
	<input type="text" id="<?php echo esc_attr( $widget->get_field_id( 'items_num' ) ); ?>" name="<?php echo esc_attr( $widget->get_field_name( 'items_num' ) ); ?>" value="<?php echo esc_attr( $instance['items_num'] ); ?>" size="2" placeholder="1" />
</p>
